    ...
    <div className="relative min-h-screen w-full bg-slate-50 darks:bg-slate-950 text-slate-900 darks:text-slate-100 font-sans antialiased flex flex-col">
            ...
            {sidebarItems.map((item) => (
              <div key={item.title} className="mb-1">
                ...
                {item.items && expandedItems[item.title] && (
                  <div className="mt-1 ml-4 border-l border-slate-200 darks:border-slate-700 pl-2 space-y-1">
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          subItem.url === pathname
                            ? "text-indigo-700 bg-indigo-50/50 darks:text-indigo-400 darks:bg-indigo-500/5"
                            : "text-slate-500 darks:text-slate-400 hover:text-slate-900 hover:bg-slate-100 darks:hover:text-slate-50 darks:hover:bg-slate-800/50",
                        )}
                      >
                        {subItem.title}
                      </Link>
      ...
      >
        ...
        <header className="sticky top-0 z-40 flex h-16 items-center justify-between px-6 bg-white/80 darks:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 darks:border-slate-800 shadow-sm shrink-0">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-md border border-indigo-200 darks:border-indigo-500/30 bg-indigo-50 darks:bg-indigo-500/10">
              <ShieldCheck
                size={16}
                className="text-indigo-600 darks:text-indigo-400"
              />
              <span className="text-xs font-semibold text-indigo-700 darks:text-indigo-300">
                Secure Session
              </span>
            </div>
          </div>
