    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="darks:text-white">Email Address</FormLabel>
              <FormControl>
                <Input
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="darks:text-white">Username</FormLabel>
              <FormControl>
                <Input
                  className="text-black"
                  type="text"
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="darks:text-white">Gender</FormLabel>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="darks:text-white">Password</FormLabel>
              <FormControl>
